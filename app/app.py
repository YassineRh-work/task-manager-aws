...
def create_app():
    ...
    def init_db():
        ...
        if existing == 0:
            demo_tasks = [
                ('Déployer infrastructure AWS', 'Utiliser CloudFormation pour créer EC2, S3, Lambda', 'high', 1),
                ('Configurer CI/CD Pipeline', 'Mettre en place CodePipeline pour déploiement automatique', 'high', 0),
                ('Implémenter monitoring', 'Configurer CloudWatch pour surveiller les métriques', 'medium', 0),
                ('Tests de charge', 'Valider les performances de l\'application', 'medium', 0),
                ('Documentation technique', 'Rédiger la documentation pour l\'équipe', 'low', 0),
                ('Optimisation coûts', 'Analyser et optimiser l\'utilisation AWS', 'low', 0)
            ]
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>🚀 Task Manager</h1>
                <p>Application Multi-Tier déployée sur AWS Cloud</p>
            </div>
            ...
            <div class="main-content">
                ...
                <div class="aws-info">
                    <h3>☁️ Architecture AWS déployée</h3>
                    <p><strong>Coût mensuel :</strong> 0€ (Free Tier) • <strong>Région :</strong> eu-west-1 • <strong>Statut :</strong> ✅ Opérationnel</p>
        ...
        if lambda_client:
            try:
                lambda_client.invoke(
                    ...
                    Payload=json.dumps({'task_id': task_id, 'action': 'created', 'title': data['title']})
                )
            except:
                pass
    ...
    def test_s3():
        ...
        try:
            bucket_name = os.environ.get('S3_BUCKET', 'final-working-221904544400-eu-west-1')
